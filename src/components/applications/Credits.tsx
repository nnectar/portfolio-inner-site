...
const CREDITS = [
    {
        ...
        rows: [['Nneoma Kanu', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Nneoma Kanu', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Nneoma Kanu', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2025 Nneoma Kanu'}
        >
            <div
